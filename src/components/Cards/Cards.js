...
function Cards({item}) {
  ...
  <div className=''>
    <img className='relative w-full  rounded-t-md' src={item.url ? item.url : 'https://firebasestorage.googleapis.com/v0/b/kamradekho-b0ede.appspot.com/o/rooms%2Fim1.png?alt=media&token=c329527e-3768-475d-b491-7bddfe7e7d48'} />
  </div>
